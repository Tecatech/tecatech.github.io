---
layout: post
title: Pwn 1 разбор месяца про ret2libc и ASLR
---
...
В качестве седьмого параметра на стеке используется адрес, указывающий на инструкцию `xor r8d, r8d` функции setvbuf:
